...
"   -0 FLOAT, --alfa0=FLOAT  Guany per determinar el llindar 0 [default: 1.08]\n"
"   -1 FLOAT, --alfa1=FLOAT  Guany per determinar el llindar 1 [default: 10.37]\n"
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    DocoptArgs args = {
        0, 0, 0, (char*) "1.08", (char*) "10.37", NULL, NULL, NULL,
